...
III、运行环境条件：虚拟主机/云主机环境优先选用Apache（Nginx下出现异常自行调试解决）、wordPress版本≥4.0，≥5.3服务器php版本≤php7.3，如果出现报错，请尝试切换php版本，[阿里云虚拟主机升级php7.x报错处理](https://www.weipxiu.com/2909.html)，注意：[请尽可能使用云服务器而不是虚拟主机](https://www.weipxiu.com/3246.html)

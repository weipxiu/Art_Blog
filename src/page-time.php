...
#header{ background:#fff; border-radius:5px; line-height:48px; font-size:16px; font-weight:bold; text-align:center; box-shadow:0 5px 7px rgba(0,0,0,0.2); color:#ed145b;}

    ...
    <div class="continar">
         <div class="continar-left" id="details">
             ...
             <div class="log-text">
                 ...
                 <h2>花絮</h2>
                 <ul>
                    <li>光阴似箭，转眼我已然毕业四个年头，博客也运行了四年，虽是个小网站，但一路走来也是煞费苦心，亦也有所收获。近年来我坚持更新文章，绝大多数教程案例都是自己尝试可行并结合自己的心得记录下来的，绝非一股脑复制粘贴，许是内容质量不是很好，但也几乎没断过，然而网站流量始终无法再提升，不会SEO的站长真的太苦了。</li>
                    <li>始初做博客只是为找工作，刚毕业没啥经验好歹弄个作品吧，首先也是用网上主题模板，如大前端DUX、更知鸟等，奈何当时才疏学浅，想法却甚多，改别人的代码何况是PHP使得经常无从下手。</li>
                    <li>那索性就自己写主题吧，要说写个简单自己用的主题并不算很难的事情，但最要命的第一步是“设计”，这让我着实为难，于是乎大量参考，看到哪个网站哪块好看就去结合自己的想法模仿升级做出来，但东拼西凑，总感觉缺少点啥，可能就是缺少协调性、灵魂！于是乎一边借鉴模仿，一边改，断断续续四年才有了现在的模样，其实大家看到的和最初展示的已经迥然不同了。</li>

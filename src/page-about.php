    ...
    <div class="continar">
         <div class="continar-left" id="details">
             ...
             <div class="log-text">
                 ...
                 <h2>花絮</h2>
                 <ul>
                    <li>光阴似箭，转眼间我已然毕业四个年头，博客也运行了四年，虽然只是个小博客，但一路走来也是煞费苦心，但也有所收获，近年来我坚持更新文章，绝大多数案例都是自己尝试可行并结合自己的心得记录下来的，绝对不是一股脑复制粘贴，可能内容质量不是很好，但也几乎没断过，然而网站流量始终无法再提升，不会搞SEO的站长真的太苦了。</li>
                    <li>最开始做博客只是为找工作，刚毕业没啥经验好歹弄个作品吧，开始也是用网上主题，如大前端DUX、更知鸟等，当时技术太菜，想法却太多，改别人的代码何况是PHP使得经常无从下手。</li>
                    <li>那索性就自己写主题吧，要说写个简单自己用的主题并不算特别难的事情，但最要命的第一步是“设计”，这让我甚是为难，于是乎大量参考，看到哪个网站哪块好看就去结合自己的想法模仿升级做出来，但东拼西凑，总感觉缺少点啥，可能就是缺少协调性、灵魂！于是乎一边借鉴模仿，一边改，断断续续四年才有了现在的模样，其实大家看到的和最初展示的已经苍海沧田了。主题做好了吧还得继续套PHP模板，网上一顿的搜索。</li>
                    <li>到底还是弄出来了，但花费了那么多时间精力，独乐了不如众乐乐，于是开源给大家一起使用。</li>
                 </ul>
                <h2>博客</h2>
                <ul>
                    <li>

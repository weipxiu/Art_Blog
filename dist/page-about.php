    ...
    <div class="continar">
         <div class="continar-left" id="details">
             ...
             <ul class="clearfix">
                ...
                <p class="px">
                    唯品秀个人博客，是我首次创建的个人博客，主要用于记录学习前端学习、工作笔记、心得的地方，抒发自己情感的地方，在今后的岁月里会慢慢来打磨并持续更新维护。通过这个博客网站，时常勉励自己，一定不能偷懒，学无止境。同时，也因此认识了不少基友，互联网将我们团聚在一起，我们共同探讨工作、学习、生活，不仅增长技术，还可以释放压力。通过这个博客网站，我善待我的每一个朋友，如果是正在学习的学生，我希望我总结的文章，能帮到你们，少走一些弯路。如果你在学习前端或者工作过程中，有什么问题，都可以咨询我或者加入我们的QQ群-610145056。
                </p>
                <p class="px">
